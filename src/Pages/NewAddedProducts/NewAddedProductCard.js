...
const NewAddedProductCard = ({addedProduct}) => {
    const{img,product_name,original_price,resale_price,seller_name,use_time,location}= addedProduct;
    return (
...
export default NewAddedProductCard;